...
namespace MVC.Controllers
{
    public class RequirementsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RequirementId,RequirementAbbrev,RequirementName,Done")] Requirement requirement)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RequirementId,RequirementAbbrev,RequirementName,Done")] Requirement requirement)
        {
